...
namespace GestioneAgenda
{
    public static class TaskManager
    {
        ...
        private static Task.Priorità InserisciLivelloPriorità()
        {
            ...
            Console.WriteLine($"Premi {(int)Task.Priorità.Bassa} per il genere {Task.Priorità.Bassa}");
            Console.WriteLine($"Premi {(int)Task.Priorità.Media} per il genere {Task.Priorità.Media}");
            Console.WriteLine($"Premi {(int)Task.Priorità.Alta} per il genere {Task.Priorità.Alta}");
            int livello;
            do
            {
